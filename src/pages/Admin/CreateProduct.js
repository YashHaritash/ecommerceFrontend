        ...
        <div className='row'>
            ...
            <div className='col-md-9'>
              <div className='card w-75 p-3'>
                ...
                <div className='m-1'>
                  <Select bordered={false} placeholder="Select A Category" showSearch className='form-select mb-3' onChange={(value)=>{setCategory(value)}}> 
                    {
                      categories.map(c => (
                  ...
                  <div className='mb-3'>
                    <input type='text' value={description} placeholder='Write Description' className='form-control' onChange={(e)=> setDescription(e.target.value)}/>
                  ...
                  <Select bordered={false} placeholder="Select Shipping" showSearch className='form-select mb-3' onChange={(value)=>{setShipping(value)}}> 
